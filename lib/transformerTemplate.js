...
//Get an object from the passed in chunk, whether in objectMode or not
...
//csv objectMode streams contain just the properties object
...
module.exports = function(addr, city, state, zip){
  ...
  function Transformer(file, pre, suf){
    ...
    //csvs are streamed via csv-parse, which is in objectMode
